...
.invoice-warning{font-size: 1.5em; color: red;text-align: center; margin: 30px 0; border-bottom: 2px solid red;}
  </style>
...
<div class="invoice-invoiced">
  ...
  if ( $trainer_invoice['preview_mode']){
    echo "<div class=\"invoice-warning\">Atension! This is only a preview of the invoice! "
    . "<br>To issue it specify a number and date</div>";
  }
  ?>

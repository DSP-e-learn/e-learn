...
2. при завършване на поръчка да се запише е таблицата courses  - date-bought, company_id, order_id, course_holder_id, date-activatted
3. Интерфейс за активиране на курс - списък с имейли и текст за писмото.
3а.при активиране на курс: 
                   - да се запише в таблицата courses - date-activatted
                   - да се запише в таблицата course-atendies - course_holder_id, user_id, firsrt_accessed, last_accessed,  score_1, score_2, score_3
                   - да се проверят имейлите от списъка и ако няма акаунти да се създадат
                   - за всеки акаунт от списъка да се добави ред в таблицата course-atendies
                   - за всеки акаунт в таблицата да се дадат права за course, course_holder, quiz
4. при завършване на тест да се запише в таблицата course-atendies - score 1,2,3
5. 
